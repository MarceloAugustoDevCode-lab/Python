...
while play != 'stop':
    play = input("Digite o \033[1;31;40m'retroceder'\033[m para voltar \033[1;31;40m'play'\033[m para tocar \033[1;31;40m'proxima'\033[m para avançar \033[1;31;40m'pause'\033[m para parar e \033[1;31;40m'stop'\033[m para sair: ")
    ...
    elif play == 'retroceder':
            totalcaminho = lista[0]
            pygame.mixer.music.play()
    elif play == 'proxima':
            totalcaminho = lista[+1]
            pygame.mixer.music.play()
    else:
